...
describe UsersController do
  ...
  describe "Get 'edit'" do
    ...
    describe "be_success" do 
      before(:each) do
        @attr = {:name=>"New Name", :email=>"newuser@user.com", :password=>"password", :password_confirmation=>"password"}
      end
  ...
  describe "authenticate of edit/update pages" do
    ...
    describe "for non-signed-in users" do
      ...
      it "should denyaccess to 'update'" do
    ...
    describe "for signed_in users" do
      before(:each) do
        wrong_user = FactoryGirl.create(:user, :name=>"anotherGuy", :email=>"user@example.net")
